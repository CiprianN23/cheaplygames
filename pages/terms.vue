...
useHead({
	...
	meta: [
		{ name: 'description', content: "CheaplyGames's terms and conditions" }
	]
});
</script>
...
<template>
	<div>
		...
		<ul>
			...
			<li>
				<p>
					...
					&quot;Us&quot;
					or &quot;Our&quot; in this Agreement) refers to Cheaply Games.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					...
					<NuxtLink to="https://www.termsfeed.com/terms-conditions-generator/" external>TermsFeed Terms and
						Conditions Generator</NuxtLink>
					.'
				</p>
			</li>
			<li>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Cheaply Games, accessible from '
					<NuxtLink to="https://www.cheaplygames.com">https://www.cheaplygames.com</NuxtLink> '
				</p>
			</li>
			<li>
				<p>
		...
		<ul>
			<li>
				<p>By email: gamescheaply@gmail.com</p>
			</li>
			<li>
				<p>
					By visiting this page on our website: '
					<NuxtLink to="https://www.cheaplygames.com/contact">https://www.cheaplygames.com/contact</NuxtLink>'
				</p>
			</li>
		</ul>
	</div>
