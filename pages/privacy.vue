...
useHead({
    ...
    meta: [
        { name: 'description', content: "CheaplyGames's privacy policy" }
    ]
});
</script>
...
<template>
    <div>
        ...
        <p>
            ...
            <NuxtLink to="https://www.termsfeed.com/privacy-policy-generator/" external>TermsFeed Privacy Policy
                Generator</NuxtLink>
            .'
        </p>
        ...
        <p>
            ...
            <NuxtLink to="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" external>TermsFeed website
            </NuxtLink>
            {' '}
            article.
        </p>
